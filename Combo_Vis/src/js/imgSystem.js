...
var imgSystem = function() {
  ...
  self.createImg = function(wCanvas) {
    ...
    img.onload = function() {
      ...
      if (wCanvas === 'img2'){
        document.getElementById('txt3').innerHTML = "<kbd>Difference Image</kbd>";
        ...
        var diffCanvas = document.getElementById('img3');
        ...
        var oldCanvas2 = canvas2.toDataURL("image/png");
        var image2 = new Image();
        image2.src = oldCanvas2;

        var img1 = ctx.getImageData(0, 0, 200, 200),
            img2 = ctx2.getImageData(0, 0, 200, 200),
            diff = diffCtx.createImageData(200, 200);

        pixelmatch(img1.data, img2.data, diff.data, 200, 200, {threshold: 0.05});
